...
def test_exec_strip_terminal_control_sequences_removes_ansi_codes() -> None:
    text = "\x1b[2mTool payload\x1b[0m\n\x1b]0;title\x07plain"
    assert ExecTool._strip_terminal_control_sequences(text) == "Tool payload\nplain"
