...
def create_provider(config: Config) -> LLMProvider:
    """Backward-compatible provider factory used by the Web runtime.

    The new core names this entry point ``make_provider``.  Keep the old
    ``create_provider`` import alive so existing Web/session code can use the
    upgraded provider stack without tripping during import.
    """
