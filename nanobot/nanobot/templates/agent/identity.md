...
## Workspace
File and shell tools run relative to the session workspace. Use relative paths.
...
- Custom skills: `shared_context/skills/{% raw %}{skill-name}{% endraw %}/SKILL.md`
